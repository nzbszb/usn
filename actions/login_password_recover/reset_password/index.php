...
if(!isset($_SESSION['usn_var_id']) && !isset($_SESSION['usn_username']) && !isset($_SESSION['usn_email']) && !isset($_SESSION['usn_mobile']))
{
    ...
    <head>
        ...
        <title>Reset Password-USN</title>
                    ...
                    <form action="reset.php" method="post">
                        <div class="panel panel-body login-form">
                            <div class="text-center">
                                ...
                                <h5 class="content-group">Reset Password <small class="display-block">Enter the recovery code sent to your email</small></h5>
                            </div>

                            <div class="form-group has-feedback">
                                <input type="text" class="form-control" name="usn_recovery_code" placeholder="Your recovery code" required>
                                <div class="form-control-feedback">
                                    <i class="icon-key text-muted"></i>
                                </div>
                            </div>
                            <div class="form-group has-feedback">
                                <input type="password" class="form-control" name="usn_password" placeholder="New password" required>
                                <div class="form-control-feedback">
                            ...
                            <a href="../" class="btn btn-default btn-block"><i class="icon-arrow-left13 position-left"></i> Back to previous page</a>
                        </div>
                    </form>
                    <!-- /password recovery -->
