...
<!--                  type="text/css">-->
            ...
            <script type="text/javascript" src="../../../assets/js/project_contents/usn_notice.min.js"></script>
                ...
                <ul class="nav navbar-nav navbar-right">
                    ...
                    <li class="dropdown dropdown-user">
                        ...
                        <ul class="dropdown-menu dropdown-menu-right">
                            <li><a id="drop-notices"><i
                                            class="icon-stack-text position-left"></i>Notices</a></li>
                            <li><a id="drop-create-notice"><i
                                            class="icon-pencil5 position-left"></i>Create Notice</a></li>
                            <li class="divider"></li>
                            <li><a href="../home"><i
                        ...
                        <div class="navbar navbar-default navbar-xs">
                            ...
                            <div class="navbar-collapse collapse text-semibold" id="navbar-filter">
                                <ul class="nav navbar-nav element-active-slate-400">
                                    <li class="active"><a href="#notices" id="notices-nav" data-toggle="tab"><i
                                                class="icon-stack-text position-left"></i>Notices</a></li>
                                    <li><a href="#create-notice" id="create-notice-nav" data-toggle="tab"><i
                                                class="icon-pencil5 position-left"></i>Create Notice</a></li>
                                </ul>
                            ...
                            <div class="col-lg-9">
                                <div class="tabbable">
                                    <div class="tab-content">
                                        <div class="tab-pane fade in active" id="notices">
...
<!--                                                Notice-->
                                                ...
                                                <?php
                                                if(sizeof($all_notice)!=0) {
                                                    $post_count=0;
                                                    foreach ($all_notice as $key2 => $post_details_f) {
                                                        $con_check = $obj_con->connectedConnection($post_details_f['username']);
                                                            if($post_details_f['username']==$_SESSION['usn_username']){
                                                                $post_user = $obj_ntc->postUser($post_details_f['username']);
                                                                $post_count = $post_count + 1;
                                                                ?>
                                                                <div id="notice-message<?php echo $post_details_f['notice_id'] ?>" class="timeline-row">
                                                                    ...
                                                                    <div class="panel panel-flat timeline-content">
                                                                        <div class="panel-heading">
                                                                            ...
                                                                            <div class="text-size-mini text-muted">
                                                                                ...
                                                                                <span id="localDateTime<?php echo $post_count; ?>"
                                                                                      class="heading-text"></span>
                                                                            </div>
                                                                            <div class="heading-elements">

                                                                                <script>
                                                                                    var local = "<?php echo $post_details_f['notice_utc_time']; ?>";
                                                                                    ...
                                                                                    if ((new_date - old_date) == 0) {
                                                                                        ...
                                                                                        $('#localDateTime<?php echo $post_count; ?>').empty();
                                                                                        document.getElementById("localDateTime<?php echo $post_count; ?>").innerHTML = ("<i class=" + 'icon-watch2' + "></i>" + day + ', ' + localDateString + ' at ' + localTimeString);
                                                                                    }
                                                                                ...
                                                                                <ul class="icons-list">
                                                                                    <li class="dropdown">
                                                                                        ...
                                                                                        <ul class="dropdown-menu dropdown-menu-right">
                                                                                            <li><a class="delete-notice" data-del_username="<?php echo $_SESSION['usn_username'] ?>" data-notice_id="<?php echo $post_details_f['notice_id'] ?>"><i
                                                                        ...
                                                                        <div class="panel-heading content-group"
                                                                            ...
                                                                            <?php
                                                                            if (!empty($post_details_f['notice_title'])) {
                                                                                ?>
                                                                                <h6 class="panel-title"
                                                                                    style="white-space: pre-line"><?php echo $post_details_f['notice_title'] ?>
                                                                                    <br><br></h6>
                                                                                <?php
                                                                            }
                                                                            if (!empty($post_details_f['notice_photo'])) {
                                                                                ?>
                                                                                <a href="../../../notice/image/<?php
                                                                                if (!empty(explode(":", $post_details_f['notice_photo'])[1])) {
                                                                                    echo explode(":", $post_details_f['notice_photo'])[1];
                                                                                } else {
                                                                                    echo explode(":", $post_details_f['notice_photo'])[0];
                                                                                } ?>"
                                                                                   class="display-block content-group"
                                                                                   data-popup="lightbox"
                                                                                   data-popup="tooltip"
                                                                                   title="<?php if (!empty($post_details_f['notice_title'])) {
                                                                                       echo $post_details_f['notice_title'];
                                                                                   } ?>">
                                                                                    <img src="../../../notice/image/<?php
                                                                                    if (!empty(explode(":", $post_details_f['notice_photo'])[1])) {
                                                                                        echo explode(":", $post_details_f['notice_photo'])[1];
                                                                                    } else {
                                                                                        echo explode(":", $post_details_f['notice_photo'])[0];
                                                                            ...
                                                                            elseif (!empty($post_details_f['notice_file'])) {
                                                                                if($post_details_f['notice_file']!='broken_image_link.png'){
                                                                                    ?>
                                                                                    <a href="../../../notice/file/<?php
                                                                                    if (!empty(explode(":", $post_details_f['notice_file'])[1])) {
                                                                                        echo explode(":", $post_details_f['notice_file'])[1];
                                                                                    } else {
                                                                                        echo explode(":", $post_details_f['notice_file'])[0];
                                                                                    } ?>"
                                                                                       class="display-block content-group"
                                                                                       data-popup="tooltip"
                                                                                       title="<?php if (!empty($post_details_f['notice_title'])) {
                                                                                           ...
                                                                                           echo $post_details_f['notice_file'];
                                                                                       } ?>">

                                                                                        <h6 class="panel-title"><?php echo explode(":", $post_details_f['notice_file'])[0] ?></h6>
                                                                                    </a>
                                                                                <?php }
                                                                                else{
                                                                                    ?>
                                                                                    <img src="../../../notice/file/broken_image_link.png" class="img-responsive content-group" alt="">

                                                                                    <?php
                                                                                }
                                                                            }
                                                                            if(!empty($post_details_f['notice_details'])){
                                                                                ?>

                                                                                <blockquote>
                                                                                    <p><?php echo $post_details_f['notice_details'] ?></p>
                                                                                </blockquote>
...
<!--                                                /notice-->
                                        ...
                                        <div class="tab-pane fade" id="create-notice">
                                            ...
                                            <input name="usn_notice_title" class="form-control mb-15" placeholder="Title" required>
                                                                <input name="usn_notice_username" value="<?php echo $value['username'];?>" type="hidden">
                                                                <input id="usn_access_type" name="usn_access_type" value="true_all" type="hidden">
                                                            </div>
                                                            <div class="form-group">
                                            <textarea name="usn_notice_details" class="form-control mb-15" rows="3" cols="1"
                                                            ...
                                                            <div class="row">
                                                                <div class="col-sm-6">
                                                                    <ul class="icons-list icons-list-extended mt-10">
                                                                        <li>
                                                                            <input type="file" class="file-input" accept=".jpeg, .jpg, .png, .gif" data-container="body" data-popup="tooltip" title="Add photo" name="usn_notice_photo" data-show-caption="false" data-show-upload="false" data-browse-class="btn btn-xs icon-images2" data-remove-class="btn btn-xs icon-images2">
                                                                        </li>
                                                                        <li>
                                                                            <input type="file" class="file-input" accept=".doc, .docx, .pdf, .txt, .xls, .xlsx, .ppt, .pptx" data-container="body" data-popup="tooltip" title="Add file" name="usn_notice_file" data-show-caption="false" data-show-upload="false" data-browse-class="btn btn-xs icon-file-plus" data-remove-class="btn btn-xs icon-file-plus">
                                                                        </li>
                                                                    </ul>
                                                                </div>
                                                                ...
                                                                <div class="col-sm-6 text-right">
                                                                    <button type="submit"
                                                                            class="btn btn-primary btn-labeled btn-labeled-right">Create
