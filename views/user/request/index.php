                            ...
                            <div class="navbar-collapse collapse text-semibold" id="navbar-filter">
                                <ul class="nav navbar-nav element-active-slate-400">
                                    <li class="active"><a href="#" data-toggle="tab"><i
                                                class="icon-people position-left"></i>Requests List</a></li>
                                </ul>
                                    ...
                                    <div class="tab-content">
                                        <div class="tab-pane fade in active" id="connection">
                                            ...
                                            <div class="content-group">
                                                ...
                                                <div class="page-header panel border-top-primary" style="background-color: #fff;">
                                                    <div class="page-header-content">
                                                        <div class="page-title">
                                                            <h5>
                                                                <?php
                                                                if(sizeof($data_cony)>1) {
                                                                    ?>
                                                                    You Have <b>"<?php echo sizeof($data_cony) ?>
                                                                        "</b> New Connection Requests
                                                                    <?php
                                                                }else {
                                                                    ?>
                                                                    You Have <b>"<?php echo sizeof($data_cony) ?>
...
<?php
        ...
        ?>
                                                                        ...
                                                                        foreach ($data_frnd as $key_frnd => $value_frnd) {
                                                                            ...
                                                                            <div class="thumbnail">
                                                                                <div class="btn-group btn-group-justified">
                                                                                    <a type="button" class="btn btn-xs bg-success" href="../account/connect.php?usn_accept_username=<?php echo $value_frnd['username'] ?>"><i class="icon-check bg-success position-left"></i> Accept</a>
                                                                                    <a type="button" class="btn btn-xs bg-warning" href="../account/connect.php?usn_reject_username=<?php echo $value_frnd['username'] ?>"><i class="icon-cross bg-warning position-left"></i> Reject</a>
                                                                                </div>
										...
										<span>
                                            ...
                                            if (!empty(($value_frnd['user_pic']))) {
                                                ?>
                                                <a href="../../../img/<?php echo $value_frnd['user_pic'] ?>"
                                                        ...
                                                        class="icon-link"></i></a>
                                                                                ...
                                                                                <div class="caption text-center">
                                                                                    <h6 class="text-semibold no-margin">
                                                                                        <a href="../account/?user=<?php echo $value_frnd['username'] ?>"> <?php echo ucwords($value_frnd['first_name']) . " " . ucwords($value_frnd['last_name']) ?></a>
                                                                                        <small
                                                                                                class="display-block"><?php echo $value_frnd['skills'] ?>
                                                                                        </small>
                                                                                        <small
                                                                                                class="display-block"><?php echo $value_frnd['user_status'] ?>
                                                                                        </small>
                                                                                    </h6>
...
?>
                                                ...
                                                <?php
                                                $userNotCon = $obj->userNotConInfo();
                                                if (sizeof($userNotCon)!=0) {
                                                    ?>
                                                    ...
                                                    <div class="row row-eq-height">
                                                        <div style="display: grid; grid-template-columns: 23.25% 23.25% 23.25% 23.25%; padding-left: 1%; padding-right: 1%; grid-gap: 2%;">
                                                            ...
                                                            foreach ($userNotCon as $key5 => $infoNotCon) {
                                                                        ?>
                                                                        <div class="thumbnail">
                                                                            <div class="btn-group btn-group-justified text-center">
                                                                                <a type="button" class="btn btn-xs bg-success" href="../account/connect.php?usn_reci_username=<?php echo $infoNotCon['username'] ?>"><i class="icon-check bg-success position-left"></i> Add Connection</a>
                                                                            </div>
                                                                            <div class="thumb thumb-rounded"
                                                                                 style="height: auto; width: auto; max-width: 140px; max-height: 140px; object-fit: cover;">
                                                                                <?php
                                                                                if (!empty($infoNotCon['user_pic'])) {
                                                                                    ?>
                                                                                    <img src="../../../img/<?php echo $infoNotCon['user_pic'] ?>"
                                                                                         alt=""
                                                                                         style="height: 140px; width: 140px; object-fit: cover;">
                                                                                    <?php
                                                                                } else {
										...
										<span>
                                            ...
                                            if (!empty(($infoNotCon['user_pic']))) {
                                                ?>
                                                <a href="../../../img/<?php echo $infoNotCon['user_pic'] ?>"
                                                   class="btn bg-success-400 btn-icon btn-xs" data-popup="lightbox"><i
                                                            class="icon-zoomin3"></i></a>
                                                <?php
                                            } else {
                                            ...
                                            ?>
                                            <a href="../account/?user=<?php echo $infoNotCon['username'] ?>"
                                               class="btn bg-success-400 btn-icon btn-xs"><i
                                                        class="icon-link"></i></a>
										</span>
                                                                                </div>
                                                                            ...
                                                                            <div class="caption text-center">
                                                                                <h6 class="text-semibold no-margin">
                                                                                    <a href="../account/?user=<?php echo $infoNotCon['username'] ?>"> <?php echo ucwords($infoNotCon['first_name']) . " " . ucwords($infoNotCon['last_name']) ?></a>
                                                                                    <small
                                                                                            class="display-block"><?php echo $infoNotCon['skills'] ?>
                                                                                    </small>
                                                                                    <small
                                                                                            class="display-block"><?php echo $infoNotCon['user_status'] ?>
                                                                                    </small>
                                                                                </h6>
                                                                                <ul class="icons-list mt-15">
                                                                                    <li><a href="#" data-popup="tooltip" title="Facebook"><i
                                                    ...
                                                    <div class="timeline timeline-left content-group">
                                                        <div class="timeline-container">
                                                            <div class="timeline-row">
                                                                <div class="content-group-sm">
                                                                    <!-- Basic alert -->
                                                                    <div class="alert alert-danger alert-styled-left text-center" style="white-space: pre-line">
                                                                        <button type="button" class="close" data-dismiss="alert"><span>&times;</span><span
                                                                                    class="sr-only">Close</span></button>
                                                                        <h2>May be we don't have many users
                                                                        OR
                                                                            You are a connection Freak!</h2>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
