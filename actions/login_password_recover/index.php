...
<head>
	...
	<title>Password Recovery-USN</title>
...
<!--								<div class="icon-object border-warning text-warning"><i class="icon-spinner11"></i></div>-->
                            ...
                            <a href="../" class="btn btn-default btn-block"><i class="icon-arrow-left13 position-left"></i> Back to Log in</a>
                            <div class="text-center"><span>*If you already have recovery code go to <a href="reset_password"><u>password reset page</u></a></span></div>
						</div>
					</form>
					<!-- /password recovery -->
