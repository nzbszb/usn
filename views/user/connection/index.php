...
<!--                <script type="text/javascript" src="../contents/chat/chat_ntf.min.js"></script>-->
                                ...
                                <div class="navbar-collapse collapse text-semibold" id="navbar-filter">
                                    <ul class="nav navbar-nav element-active-slate-400">
                                        <li class="active"><a href="#" data-toggle="tab"><i
                                                    class="icon-collaboration position-left"></i>Connection List</a></li>
                                    </ul>
        ...
        ?>
                                                                ...
                                                                if ($con_value['send_username'] != $_SESSION['usn_username']) {
                                                                    ...
                                                                    <div class="thumbnail">
                                                                        <div class="btn-group btn-group-justified">
                                                                            <a type="button" class="btn btn-xs bg-warning" href="../account/connect.php?usn_reject_username=<?php echo $data_details['username'] ?>"><i class="icon-cross bg-warning position-left"></i> Delete Connection</a>
                                                                        </div>
										...
										<span>
                                            ...
                                            if (!empty(($data_details['user_pic']))) {
                                                ?>
                                                <a href="../../../img/<?php echo $data_details['user_pic'] ?>"
                                                        ...
                                                        class="icon-link"></i></a>
                                                                        ...
                                                                        <div class="caption text-center">
                                                                            <h6 class="text-semibold no-margin">
                                                                                <a href="../account/?user=<?php echo $data_details['username'] ?>"> <?php echo ucwords($data_details['first_name']) . " " . ucwords($data_details['last_name']) ?></a>
                                                                                <small
                                                                                        class="display-block"><?php echo $data_details['skills'] ?>
                                                                                </small>
                                                                                <small
                                                                                        class="display-block"><?php echo $data_details['user_status'] ?>
                                                                                </small>
                                                                            </h6>
                                                                    ...
                                                                    <?php
                                                                } elseif ($con_value['reci_username'] != $_SESSION['usn_username']) {
