$(document).ready(function() {
    ...
    $('.mychat').click(function (e) {
        ...
        ajaxFn = setInterval(function () {
            if (!trigger_chat){
                return;
            }
        currentRequest = jQuery.ajax({
            type: 'post',
            url: '../../../views/user/contents/chat_modal/chat.php', //Here you will fetch records
...
//         $('#chat-content').append(chat_data_con);//Show fetched data from user
        ...
        var options = {
            type: 'post',
            url: '../../../views/user/contents/chat_modal/chat.php',
            dataType: 'json',
            cache: false,
            context: this,
            beforeSend: function () {
    ...
    setInterval(function ajaxChtNtf() {
        window.load = $('.chat_ntf').each(function () {
            ...
            $.ajax({
                type: 'post',
                url: '../../../views/user/contents/toolbar_messages/chat_ntf.php', //Here you will fetch records
                data: row, //Pass $id
                dataType: 'json',
                cache: false,
                context: this,
    ...
    setInterval(function ajaxFnUsers() {
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                if (data.length != 0) {
                    ...
                    for (i = 0; i < data.length; i++) {
                        ...
                        $('.mychat_tlbr').addClass('media-heading');
            ...
            complete: function (data) {
                $('.mychat_tlbr').click(function (e) {
                    ...
                    ajaxFnTl = setInterval(function () {
                        if(!trigger_chat_tlbr){
                            if((send_username=='undefined') || (send_username==null)){
                                trigger_chat_tlbr = false;
                            }else{
                                trigger_chat_tlbr = true;
                            }
